            ...
            views: [
              ...
              completedOrder.length == 0
                  ...
                  : RefreshIndicator(
                      ...
                      child: ListView(
                        children: completedOrder.map((e) {
                          return e['current_status'].toString() == "Returned"
                              ? SizedBox()
                              : InkWell(
                                  onTap: () {
              ...
              returnItems.length == 0
                  ...
                  : RefreshIndicator(
                      onRefresh: () async {
                        ...
                        OtherAPI()
                            .returnReplacementRequestList("1")
                            .then((value) {
                          setState(() {
                            returnItems.addAll(value);
                          });
                          OtherAPI()
                              .returnReplacementRequestList("2")
                              .then((value) {
                            setState(() {
                              returnItems.addAll(value);
                              isLoading = false;
